...
- [ ] **Self-Review:** The writer has performed a final check against this list. (Reviewer: Self, Colleague)
- [ ] **Editor Review:** Content approved for clarity, accuracy, and tone. (Reviewer: Supervisor)
- [ ] **Legal/Compliance Review (if required):** Content checked for any legal or privacy issues. (Reviewer: Legal team)
